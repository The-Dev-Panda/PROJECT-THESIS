            ...
            <form action="process_add_exercise.php" method="POST">
                <div class="form-grid">
                    <div class="form-group" style="grid-column: span 3;">
                        ...
                        <input type="text" class="form-input" name="name" placeholder="Enter exercise name" required maxlength="255">
                    </div>

                    <div class="form-group">
                        <label>Target Muscle</label>
                        <input type="text" class="form-input" name="target_muscle" placeholder="e.g., Chest, Biceps" maxlength="100">
                    </div>
