        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div id="mediaMain" class="media-main">
                    <img src="../images/CableMachine-Pullups.png" alt="Cable Machine">
                </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <ol style="margin-top:8px; color:#c9d6e1; font-size:14px">
                    <li>Adjust cable height for each exercise.</li>
                    <li>Use various attachments to target muscles.</li>
