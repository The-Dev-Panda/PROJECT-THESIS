        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div id="mediaMain" class="media-main">
                    <img src="../images/Fitstop.png" alt="Leg Press / Hack Squat">
                </div>
                ...
                <div class="thumbs" id="thumbs">
                    <button type="button"
                        ...
                        <img src="../images/Fitstop.png" alt="Leg Press / Hack Squat Photo">
                    </button>
                </div>
                            ...
                            <article class="ex-card">
                                ...
                                <div>
                                    ...
                                    <div style="font-size:13px; color:#9fb1c7">
                                        Primary muscle &bull; Quads, Glutes
                                    </div>
                                </div>
                            </article>
                        </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <ul class="meta-list" style="margin-top:10px">
                    ...
                    <li><strong>Difficulty:</strong> Beginner &mdash; Advanced</li>
            ...
            <div class="card">
                ...
                <ol style="margin-top:8px; color:#c9d6e1; font-size:14px">
                    ...
                    <li>Lower with control, push through heels.</li>
                    <li>Don't lock out knees completely at the top.</li>
                </ol>
            </div>
