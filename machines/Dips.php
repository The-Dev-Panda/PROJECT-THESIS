...
<div class="container-inner">
    ...
    <h1 class="mb-4">Dips / Leg Raise Station</h1>
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div id="mediaMain" class="media-main">
                    <img src="../images/DIPS.png" alt="Dips Machine">
                </div>
                
                <!-- Thumbnails -->
                <div class="thumbs" id="thumbs">
                    <button type="button" 
                            data-src="../images/DIPS.png" 
                            data-type="image" 
                            aria-label="View photo 1">
                        <img src="../images/DIPS.png" alt="Dips Machine Photo" loading="lazy" decoding="async">
                    </button>
                        
                    <button type="button" 
                            data-src="../images/DipBar.png" 
                            data-type="image" 
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <form style="margin-top:12px" action="../Database/submit_feedback.php" method="POST">
                    <input type="hidden" name="machine" value="Dips / Leg Raise Station">
