                        ...
                        <div class="col">
                            <article class="ex-card">
                                ...
                                <div>
                                    ...
                                    <div style="font-size:13px; color:#9fb1c7">
                                        Primary muscle &bull; Lats, Biceps
                                    </div>
                                </div>
                            </article>
                        </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <ul class="meta-list" style="margin-top:10px">
                    ...
                    <li><strong>Difficulty:</strong> Intermediate &mdash; Advanced</li>
            ...
            <div class="card">
                ...
                <ol style="margin-top:8px; color:#c9d6e1; font-size:14px">
                    <li>Start from a dead hang position.</li>
                    <li>Pull with your elbows, not your hands.</li>
                    <li>Chin should clear the bar at the top.</li>
                </ol>
            </div>
