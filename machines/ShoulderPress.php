            ...
            <div class="card">
                ...
                <div class="thumbs" id="thumbs">
                    <button type="button"
                        ...
                        <img src="../images/Fitstop.png" alt="Shoulder Press Photo">
                    </button>
                </div>
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card">
                ...
                <ol style="margin-top:8px; color:#c9d6e1; font-size:14px">
                    <li>Sit with your back firmly against the pad.</li>
                    <li>Press handles straight up overhead.</li>
                    <li>Avoid locking elbows at the top.</li>
                </ol>
            </div>
